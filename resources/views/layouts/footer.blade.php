<footer class="py-10 text-white bg-black">
    <div class="container px-4 mx-auto">
      ...
      <div class="mb-8 text-center">
        <h1 class="font-serif text-4xl font-bold">TRENZLY</h1>
        <hr class="my-4 border-gray-600">
      </div>


      <div class="grid gap-8 mb-8 sm:grid-cols-2 lg:grid-cols-3">


        <div>
          <h2 class="mb-4 text-lg font-semibold">MENU</h2>
          <ul class="grid grid-cols-2 space-y-1">
            <li><a href="#" class="hover:text-gray-400">HOME</a></li>
            <li><a href="#" class="hover:text-gray-400">GIFT CARDS</a></li>
            <li><a href="#" class="hover:text-gray-400">MEN'S</a></li>
            <li><a href="#" class="hover:text-gray-400">ACCESSORIES</a></li>
            <li><a href="#" class="hover:text-gray-400">WOMEN'S</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="grid grid-cols-2 space-y-1">
            ...
            <li><a href="#" class="hover:text-gray-400">SUBMIT A REQUEST</a></li>
        ...
        <div>
          <h2 class="mb-4 text-lg font-semibold">Join the Community!</h2>
          <p class="mb-4 text-gray-400">
            Hey! Drop your E-mail address and join the Community. We don't spam.
            Just sick Deals and Early updates on new collections.
          </p>
          <form>
            <input type="email" placeholder="Email address" class="w-full p-2 bg-gray-800 border border-gray-600 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-500">
          </form>
        </div>
      ...
      <div class="flex flex-col justify-between pt-4 mt-8 space-y-8 sm:flex-row sm:space-y-0">
        ...
        <div class="text-center">
          <p class="text-sm">&copy; 2024 TRENZLY. All rights reserved.</p>
        </div>
      ...
      <p class="text-sm text-center text-gray-600">Designed & Developed by Dinuka</p>
  </footer>