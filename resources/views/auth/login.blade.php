<x-guest-layout>
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
            ...
            <a class="text-indigo-600 underline rounded-md dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('register') }}" wire:navigate>
